...
describe('TS Compose', () => {
  it.each<[string, ts.Node]>([
    ...
    ['Test', Type.Ref('Test')],
    ['Test.Other', Type.Ref(['Test', 'Other'])],
    ['Test.Other.Still', Type.Ref(['Test', 'Other', 'Still'])],
    ['Test<Other>', Type.Ref('Test', [Type.Ref('Other')])],
    ['Test<Other, Other2>', Type.Ref('Test', [Type.Ref('Other'), Type.Ref('Other2')])],
    ['Test.Other<Me>', Type.Ref(['Test', 'Other'], [Type.Ref('Me')])],
