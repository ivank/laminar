...
export namespace UkCoBoostpowerSupportKafkaMessages {
  export const AccountMigrationCancelledEventName =
  ...
  export const AccountMigrationCompletedEventName =
  ...
  export const AccountMigrationRollBackInitiatedEventName =
    'uk.co.boostpower.support.kafka.messages.AccountMigrationRollBackInitiatedEvent';
  /**
  ...
  export const AccountMigrationRolledBackEventName =
    'uk.co.boostpower.support.kafka.messages.AccountMigrationRolledBackEvent';
  /**
  ...
  export const AccountMigrationScheduledEventName =
    'uk.co.boostpower.support.kafka.messages.AccountMigrationScheduledEvent';
  /**
  ...
  export const AccountMigrationValidatedEventName =
    'uk.co.boostpower.support.kafka.messages.AccountMigrationValidatedEvent';
  /**
  ...
  export const BalanceRetrievedMigrationEventName =
