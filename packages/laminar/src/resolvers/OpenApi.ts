  ...
  definitions: {
    ...
    schema: {
      ...
      properties: {
        ...
        title: {
          $ref: '#/json-schema/properties/title',
        },
        multipleOf: {
          $ref: '#/json-schema/properties/multipleOf',
        },
        maximum: {
          $ref: '#/json-schema/properties/maximum',
        },
        exclusiveMaximum: {
          $ref: '#/json-schema/properties/exclusiveMaximum',
        },
        minimum: {
          $ref: '#/json-schema/properties/minimum',
        },
        exclusiveMinimum: {
          $ref: '#/json-schema/properties/exclusiveMinimum',
        },
        maxLength: {
          $ref: '#/json-schema/properties/maxLength',
        },
        minLength: {
          $ref: '#/json-schema/properties/minLength',
        },
        pattern: {
          $ref: '#/json-schema/properties/pattern',
        },
        maxItems: {
          $ref: '#/json-schema/properties/maxItems',
        },
        minItems: {
          $ref: '#/json-schema/properties/minItems',
        },
        uniqueItems: {
          $ref: '#/json-schema/properties/uniqueItems',
        },
        maxProperties: {
          $ref: '#/json-schema/properties/maxProperties',
        },
        minProperties: {
          $ref: '#/json-schema/properties/minProperties',
        },
        required: {
          $ref: '#/json-schema/properties/required',
        },
        enum: {
          $ref: '#/json-schema/properties/enum',
        },
        type: {
          type: 'string',
        },
  ...
  'json-schema': {
    ...
    definitions: {
      ...
      positiveIntegerDefault0: {
        allOf: [{ $ref: '#/json-schema/definitions/positiveInteger' }, { default: 0 }],
      },
      simpleTypes: {
    ...
    properties: {
      ...
      maxLength: { $ref: '#/json-schema/definitions/positiveInteger' },
      minLength: { $ref: '#/json-schema/definitions/positiveIntegerDefault0' },
      pattern: {
        type: 'string',
        format: 'regex',
      },
      ...
      items: {
        anyOf: [{ $ref: '#' }, { $ref: '#/json-schema/definitions/schemaArray' }],
        default: {},
      },
      maxItems: { $ref: '#/json-schema/definitions/positiveInteger' },
      minItems: { $ref: '#/json-schema/definitions/positiveIntegerDefault0' },
      uniqueItems: {
        type: 'boolean',
        default: false,
      },
      maxProperties: { $ref: '#/json-schema/definitions/positiveInteger' },
      minProperties: { $ref: '#/json-schema/definitions/positiveIntegerDefault0' },
      required: { $ref: '#/json-schema/definitions/stringArray' },
      additionalProperties: {
        anyOf: [{ type: 'boolean' }, { $ref: '#' }],
        default: {},
      },
      ...
      dependencies: {
        type: 'object',
        additionalProperties: {
          anyOf: [{ $ref: '#' }, { $ref: '#/json-schema/definitions/stringArray' }],
        },
      },
      enum: {
        type: 'array',
      ...
      type: {
        anyOf: [
          { $ref: '#/json-schema/definitions/simpleTypes' },
          {
            type: 'array',
            items: { $ref: '#/json-schema/definitions/simpleTypes' },
            minItems: 1,
            uniqueItems: true,
          },
        ],
      ...
      format: { type: 'string' },
      allOf: { $ref: '#/json-schema/definitions/schemaArray' },
      anyOf: { $ref: '#/json-schema/definitions/schemaArray' },
      oneOf: { $ref: '#/json-schema/definitions/schemaArray' },
      not: { $ref: '#' },
    },
    dependencies: {
