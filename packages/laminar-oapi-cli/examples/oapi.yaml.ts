...
export type TTestPostResponse = (Test | LaminarResponse<Test> | Promise<Test> | Promise<LaminarResponse<Test>>);

export interface TTestPostContext extends Context, OapiContext {
    body: User;
}

export type TTestGetResponse = (Test | LaminarResponse<Test> | Promise<Test> | Promise<LaminarResponse<Test>>);
