import { OapiContext, OapiConfig, Empty, HttpListener, openApi, OapiSecurityResolver, OapiAuthInfo, ResponseOapi } from "@laminarjs/laminar";
 ...
 * Retern meter reads
 */
export type PathV1MeterreadsGet<R extends Empty = Empty, TAuthInfo extends OapiAuthInfo = OapiAuthInfo> = (req: RequestV1MeterreadsGet<TAuthInfo> & R) => Promise<ResponseV1MeterreadsGet>;

export interface HttpError {
    message?: string;
}

export type ResponseV1HydrationMeterreadsPost = ResponseOapi<{
    success: boolean;
}, 200, "application/json"> | ResponseOapi<HttpError, 400, "application/json"> | ResponseOapi<HttpError, 500, "application/json">;
 ...
 *
 */
export type PathV1HydrationMeterreadsPost<R extends Empty = Empty, TAuthInfo extends OapiAuthInfo = OapiAuthInfo> = (req: RequestV1HydrationMeterreadsPost<TAuthInfo> & R) => Promise<ResponseV1HydrationMeterreadsPost>;
