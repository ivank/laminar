import { start, stop, Laminar } from '@ovotech/laminar';
...
let petstore: Laminar;
let pool: Pool;
const port = 8822;
const hostname = 'localhost';
const connectionString = 'postgres://petstore-admin:petstore-pass@localhost:5001/petstore';
...
describe('Petstore Integration Tests', () => {
  beforeEach(async () => {
    ...
    petstore = await createApp({ secret, pool, logger, port, hostname });
